...
class MessageController extends Controller
{
    ...
    {
        $text = Message::where('id', $request->id);
        ...
        $body = [
            ...
            'messages' => [[
                'role' => 'user',
                'content' => 'Ты сказочник, который рассказывает истории для детей. Тебе нужно составить небоольшую историю на основе следющего текста: Пингвин попал в Омск.'
            ]],
            'stream' => false
        ];
